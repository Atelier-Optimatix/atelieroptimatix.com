...
const id = "it/duesautomata.mdoc";
						const collection = "works";
						const slug = "it/duesautomata";
						...
						const data = {title:"Deus Automata",pubDate:new Date(1707955200000),lastUpdateDate:new Date(1709251200000),cover:
						new Proxy({"src":"/_astro/cover.D_pAC8Fx.jpg","width":1152,"height":768,"format":"jpg","fsPath":"/Users/shamil/Workspace/atelieroptimatix.com/mld/src/assets/works/nexacore/cover.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/shamil/Workspace/atelieroptimatix.com/mld/src/assets/works/nexacore/cover.jpg";
							}
							
							return target[name];
						}
					})
					,description:"Advancing industrial process optimisation through smart automation, adaptive AI control, and real-time monitoring systems.",tags:["Industrial IoT","Automation","Process Optimisation","AI Control Systems"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/shamil/Workspace/atelieroptimatix.com/mld/src/content/works/it/duesautomata.mdoc",
