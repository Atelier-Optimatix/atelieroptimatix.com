...
const id = "it/simmeringerp.mdoc";
						const collection = "works";
						const slug = "it/simmeringerp";
						...
						const data = {title:"Simmering ERP",pubDate:new Date(1715040000000),lastUpdateDate:new Date(1715040000000),cover:
						new Proxy({"src":"/_astro/cover.BZ5o4vAQ.jpg","width":768,"height":1152,"format":"jpg","fsPath":"/Users/shamil/Workspace/atelieroptimatix.com/mld/src/assets/works/vortextech/cover.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/shamil/Workspace/atelieroptimatix.com/mld/src/assets/works/vortextech/cover.jpg";
							}
							
							return target[name];
						}
					})
					,description:"Streamline your restaurant operations with Simmering ERP, an all-in-one solution for efficient management, from inventory to customer experience.",tags:["Restaurant Management","ERP Systems","Process Automation","Inventory Management","Customer Engagement"]};
						const _internal = {
							type: 'content',
							filePath: "/Users/shamil/Workspace/atelieroptimatix.com/mld/src/content/works/it/simmeringerp.mdoc",
